...
EXPECTED_OUTCOMES = {
    ...
    "3 obj styles.zip": {  # One object syle not on textframe/image
        "errors": [
            f"{ValidationError.OBJECT_STYLE_IMAGE.value}",
            f"{ValidationError.OBJECT_STYLE_IMAGE.value}",
        ],
    ...
    "1023_SEMCO_OTHER_3984112_Overview_FS_TEMP_RES_PRINT Folder.zip": {
        "errors": [
            f"{ValidationError.OBJECT_STYLE_TEXT.value}",
            f"{ValidationError.OBJECT_STYLE_TEXT.value}",
            f"{ValidationError.OBJECT_STYLE_IMAGE.value}",
